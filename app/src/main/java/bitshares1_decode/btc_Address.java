 ...
 */
public class btc_Address extends ByteSerializable {
    ...
    public btc_Address(ECKey pub_key) {
    ...
    public btc_Address(ECKey key, int version) {
    ...
    public btc_Address(String address) throws MalformedAddressException {
    ...
    public static String from_pubkey_to_address(ECKey pub_key,byte version){
        btc_Address temp_address = new btc_Address(pub_key,version);
        return temp_address.toString();
    }
    public static String from_pubkey_to_address(ECKey pub_key){
        btc_Address temp_address = new btc_Address(pub_key,default_version);
        return temp_address.toString();
    }
