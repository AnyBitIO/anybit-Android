...
public class Configuration {
   ...
   /* @Nullable
    ...
    public void touchLastAccountId(String accountId) {
        String lastAccountId = prefs.getString(PREFS_KEY_LAST_ACCOUNT, WalletConstants.DEFAULT_COIN.getId());
    ...
    /*public Map<CoinType, Value> getFeeValues() {
        ...
        for (CoinType type : WalletConstants.SUPPORTED_COINS) {
    ...
    *//**
    ...
    public String getExchangeCurrencyCode(boolean useDefaultFallback) {
        ...
        if (useDefaultFallback) {
            ...
            defaultCode = defaultCode == null ? WalletConstants.DEFAULT_EXCHANGE_CURRENCY : defaultCode;
        }
