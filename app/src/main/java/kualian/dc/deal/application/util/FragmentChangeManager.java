...
public class FragmentChangeManager {
    ...
    /** Fragment切换数组 */
    private ArrayList<MySupportFragment> mFragments;
    /** 当前选中的Tab */
    private int mCurrentTab;

    public FragmentChangeManager(FragmentManager fm, int containerViewId, ArrayList<MySupportFragment> fragments) {
