...
public class RxToast {
    ...
    public static void showToast(int resId) {
        ...
        Context context = LanguageUtil.attachBaseContext(WalletApp.getContext(), language);
        if (mToast == null) {
            mToast = Toast.makeText(getContext(), context.getResources().getString(resId), Toast.LENGTH_LONG);
        } else {
