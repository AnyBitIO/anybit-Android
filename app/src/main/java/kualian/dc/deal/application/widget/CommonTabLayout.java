...
import kualian.dc.deal.application.callback.OnTabSelectListener;
import kualian.dc.deal.application.util.FragmentChangeManager;
import kualian.dc.deal.application.util.UnreadMsgUtils;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //getWallet layout_height
        String height = attrs.getAttributeValue("http://schemas.android.com/apk/res/android", "layout_height");

        //getInstance ViewPager
    ...
    /** 关联数据支持同时切换fragments */
    public void setTabData(ArrayList<CustomTabEntity> tabEntitys, FragmentActivity fa, int containerViewId, ArrayList<MySupportFragment> fragments, boolean isBottom) {
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    public void setCurrentTab(int currentTab) {
        ...
        tabPosition=currentTab;
        if (mFragmentChangeManager != null) {
            mFragmentChangeManager.setFragments(tabPosition);
        }
        if (mIndicatorAnimEnable) {
            calcOffset();
        } else {
