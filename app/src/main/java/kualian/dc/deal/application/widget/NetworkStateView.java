...
public class NetworkStateView extends LinearLayout {
    ...
    public NetworkStateView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.NetworkStateView_nsvTextSize, CommonUtil.dip2px(14));

        typedArray.recycle();

        mInflater = LayoutInflater.from(context);
        params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        //setBackgroundColor(WalletApp.getContext().getResources().getColor(R.color.white));
    }
    ...
    public void showLoading() {
        ...
        loadingView =mLoadingView.findViewById(R.id.loading_news);
       // loadingView.setViewColor(Color.parseColor("#06c2ad"));
