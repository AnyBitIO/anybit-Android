package kualian.dc.deal.application.widget.loading;
...
import kualian.dc.deal.application.widget.BallTrianglePathIndicator;
import kualian.dc.deal.application.widget.Indicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void updateDrawableBounds(int w, int h) {
        ...
        if (mIndicator != null) {
            ...
            // getWallet very confused otherwise.
